...
#
# call genotypes using APT 1.16.1 and SNPolisher (istraw35 not supported as far as I know)
# this script only deals with a single batch of samples at once
# you must create the list of input cel files first
#
# usage: affycall_apt1.16.1.sh <input_celfile_list> \
#                              istraw35|istraw90 \
...
export PATH=/home/vicker/programs/apt-1.16.1-x86_64-intel-linux/bin:${PATH}

#choose datatype - istraw35 appears not to work with this version of APT
